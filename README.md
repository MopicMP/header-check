...
> Check HTTP security headers of a URL

[![PyPI version](https://badge.fury.io/py/header-check.svg)](https://pypi.org/project/header-check/)
...
```bash
pip install header-check
```

## Quick Start

```python
from header_check import check
...
from header_check import batch
